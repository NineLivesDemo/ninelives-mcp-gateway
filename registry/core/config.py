...
class Settings(BaseSettings):
    ...
    #   "openai_http" -> standard OpenAI envelope, but call the configured endpoint
    #                     directly to avoid provider-specific LiteLLM request rewriting.
    embeddings_response_format: str = "openai"  # "openai" | "raw_array" | "openai_http"
