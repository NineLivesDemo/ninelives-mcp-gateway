...
class TestLiteLLMClient:
    ...
    def test_set_api_key_env_voyage(self):
        """Test setting Voyage API key environment variable."""
        # Arrange
        original_value = os.environ.get("VOYAGE_API_KEY")
        ...
        try:
            ...
            # Assert
            assert os.environ.get("VOYAGE_API_KEY") == "test-voyage-key"
        finally:
            # Cleanup
            if original_value:
